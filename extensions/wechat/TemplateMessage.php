...
class TemplateMessage {
	...
	public static function setIndustry($industryId1, $industryId2) {
		$queryUrl = Common::URL . 'cgi-bin/template/api_set_industry?access_token='.AccessToken::getAccessToken();
		$template = [];
	...
	public static function getTemplateId($templateIdShort) {
		$queryUrl = Common::URL . 'cgi-bin/template/api_add_template?access_token='.AccessToken::getAccessToken();
		$template = [];
	...
	public static function sendTemplateMessage($data, $touser, $templateId, $url, $topcolor='#FF0000') {
		$queryUrl = Common::URL . 'cgi-bin/message/template/send?access_token='.AccessToken::getAccessToken();
		$template = [];
