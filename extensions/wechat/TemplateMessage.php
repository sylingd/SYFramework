...
class TemplateMessage {
	...
	public static function setIndustry($industryId1, $industryId2){
		$queryUrl = Config::URL . 'cgi-bin/template/api_set_industry?access_token='.AccessToken::getAccessToken();
		$queryAction = 'POST';
		$template = array();
	...
	public static function getTemplateId($templateIdShort){
		$queryUrl = Config::URL . 'cgi-bin/template/api_add_template?access_token='.AccessToken::getAccessToken();
		$queryAction = 'POST';
		$template = array();
	...
	public static function sendTemplateMessage($data, $touser, $templateId, $url, $topcolor='#FF0000'){
		$queryUrl = Config::URL . 'cgi-bin/message/template/send?access_token='.AccessToken::getAccessToken();
		$queryAction = 'POST';
		$template = array();
