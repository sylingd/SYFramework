...
class UserManage {
	...
	public static function createGroup($groupName){
		...
		$queryUrl = Config::URL . 'cgi-bin/groups/create?access_token='.$accessToken;
	...
	public static function getGroupList(){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/groups/get?access_token='.$accessToken;
		$data = '';
	...
	public static function getGroupByOpenId($openId){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/groups/getid?access_token='.$accessToken;
		$data = '{"openid":"'.$openId.'"}';
		return Curl::callWebServer($queryUrl, $data, 'POST');
	...
	public static function editGroupName($groupId, $groupName){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/groups/update?access_token='.$accessToken;
	...
	public static function editUserGroup($openid, $to_groupid){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/groups/members/update?access_token='.$accessToken;
	...
	public static function getUserInfo($openId){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/user/info?access_token='.$accessToken.'&openid='.$openId;
	...
	public static function getFansList($next_openid=''){
		...
		if(empty($next_openid)){
			$queryUrl = Config::URL . 'cgi-bin/user/get?access_token='.$accessToken;
		}else{
			$queryUrl = Config::URL . 'cgi-bin/user/get?access_token='.$accessToken.'&next_openid='.$next_openid;
		}
		return Curl::callWebServer($queryUrl, '', 'GET');
	}
	...
	public static function setRemark($openId, $remark){
		//获取ACCESS_TOKEN
		$accessToken = AccessToken::getAccessToken();
		$queryUrl = Config::URL . 'cgi-bin/user/info/updateremark?access_token='.$accessToken;
